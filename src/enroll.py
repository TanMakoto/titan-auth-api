        ...
        for user_name in users:
            ...
            if os.path.exists(img_dir):
                for file in os.listdir(img_dir):
                    ...
                    try:
                        # Use retinaface to match the API and ensure only the cropped face is embedded
                        emb = DeepFace.represent(img_path=img_path, model_name="VGG-Face", enforce_detection=True, detector_backend="retinaface")
